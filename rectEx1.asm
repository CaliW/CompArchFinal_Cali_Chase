...
# Example of drawing a rectangle; left x-coordinate is 100, width is 8
# top y-coordinate is 200, height is 8. Coordinate system starts with
...
li $t0,0x00FF0000 # -1 = color: white
la $t1,frameBuffer
